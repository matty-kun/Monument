      ...
      <div className="container mx-auto px-6 py-4 flex justify-between items-center max-w-7xl">
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2">
            {role === "admin" && (
              <Link href="/admin/dashboard" className={`px-4 py-2 rounded-lg text-sm font-medium text-white bg-monument-green hover:bg-green-700 dark:bg-green-600 dark:hover:bg-green-700 transition-all shadow-sm ${pathname.startsWith('/admin') ? 'ring-2 ring-offset-2 ring-green-500' : ''}`}>
                📊 Dashboard
              </Link>
            )}
            <ThemeSwitcher />
