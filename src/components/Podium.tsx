  ...
  return (
    <div className="flex justify-center items-end space-x-4">
      {topThree.map((dept, index) => {
        ...
        const height = rank === 1 ? "h-48" : rank === 2 ? "h-32" : "h-24";
        ...
        return (
          ...
          >
            ...
            <div className="w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden border-4 border-gray-300 mb-4">
              {dept.image_url ? (
            ...
            <div className="text-center">
              ...
              <div className="text-base">{dept.total_points} pts</div>
            </div>
            <div
              className={`w-40 md:w-56 rounded-t-lg text-center text-black font-bold p-4 ${bgColor} ${height}`}
            >
