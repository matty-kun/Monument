...
export default function LeaderboardClientPage({ initialLeaderboard, initialMysteryMode, tournamentId, tournamentName }: LeaderboardClientPageProps) {
  ...
  return (
    <div className="bg-black text-white min-h-[100dvh] pb-28 font-sans relative overflow-x-hidden flex flex-col">
      {/* Sporty Diagonal Lines Texture */}
      <div 
        className="absolute inset-0 pointer-events-none z-0 opacity-10 mix-blend-normal"
        style={{ 
        ...
        {mysteryMode ? (
          ...
          >
            <div className="flex flex-col items-center text-center pb-8 gap-4">
              <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 bg-white/10 px-5 py-2 rounded-full border border-white/10">
                <Sparkles size={12} />
              ...
              <div className="text-4xl font-black text-white text-center tracking-tight leading-tight">
                Who will take <br />
                <span className="text-gray-500">the Crown?</span>
              </div>
            </div>
          ...
          >
            {hasScores ? (
              ...
              <div className="flex-1 flex flex-col justify-center items-center text-center p-4">
                ...
                <div className="text-2xl font-bold text-white mb-4">{tournamentName}</div>
